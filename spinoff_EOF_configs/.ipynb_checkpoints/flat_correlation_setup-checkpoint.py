''' Copied from correlation.py, aiming to generate a bunch of weight files that are just ones.
...
if __name__ == "__main__":
    ...
    for init_month in args.init_months:
        ...
        ones.to_netcdf(out_folder+'/weights.nc')
