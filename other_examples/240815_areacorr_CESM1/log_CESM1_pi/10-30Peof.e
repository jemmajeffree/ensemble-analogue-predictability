...
Hosting the HTTP server on port 43613 instead
  warnings.warn(
/glade/u/home/jjeffree/ensemble-analogue-predictability/eof_calculation.py:53: UserWarning: Model data aquired; CESM1_pi; 6.239476680755615 s
  warnings.warn('Model data aquired; '+data_name+"; "+str(time.time()-t0)+' s')
/glade/u/home/jjeffree/ensemble-analogue-predictability/eof_calculation.py:56: UserWarning: Calculating 10-30P
  warnings.warn('Calculating '+mask)
2025-02-05 14:32:02,674 - distributed.worker - ERROR - Failed to communicate with scheduler during heartbeat.
...
distributed.comm.core.CommClosedError: in <TCP (closed) ConnectionPool.heartbeat_worker local=tcp://127.0.0.1:59622 remote=tcp://127.0.0.1:32929>: Stream is closed
