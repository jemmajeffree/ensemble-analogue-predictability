...
# WEIGHT_ID=$(qsub -r y -v MODEL_NAME=$MODEL_NAME submit_corr.sh)
# echo "weight: "$weight_ID

#EOF_ID=$(qsub -W depend=afterok:$WEIGHT_ID -r y -v MODEL_NAME=$MODEL_NAME submit_eof.sh)
...
# PCA_ID2=$(qsub -W depend=afterok:$PCA_ID -r y -v MODEL_NAME=$MODEL_NAME submit_pca2.sh)
# #PCA_ID2=$(qsub -r y -v MODEL_NAME=$MODEL_NAME submit_pca2.sh)
# echo "pca2: "$PCA_ID2

#ANALOG_ID=$(qsub -W depend=afterok:$PCA_ID2 -r y -v MODEL_NAME=$MODEL_NAME submit_analogue.sh)
