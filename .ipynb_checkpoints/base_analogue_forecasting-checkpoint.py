...
if __name__ == "__main__":
    ...
    if (lib_mi*args.lib_size+args.lib_size)>pt.n_ensemble_members[data_name]: #If end member (exclusive) is > than number of members
    ...
    lib_index = args.calc_corr_index(lib_model_ss)
    ...
    if data_name == lib_data_name:
        ...
        data_index = args.calc_corr_index(data_model_ss)
    ...
    for m in mask_list:
        ...
        out_filename = args.analogue_output_folder+'_'.join(data_name_list)+'_'+'_'.join(vars)+'/'+m+'_'+str(lib_mi)+'.nc'
